...
const CourseInformationForm = () => {
    ...
    const onSubmit = async (data) => {
        ...
        formData.append("courseDescription", data.courseShortDesc);
        // console.log("formdata[courseDescription]: ",formData.get("courseDescription"))
        formData.append("price", data.coursePrice);
        // console.log("formdata[price]: ",formData.get("price"))
        formData.append("whatYouWillLearn", data.courseBenefits);
        // console.log("formdata[whatYouWillLearn]: ",formData.get("whatYouWillLearn"))
        formData.append("category", data.courseCategory);
        // console.log("formdata[category]: ",formData.get("category"))
        formData.append("instructions", JSON.stringify(data.courseRequirements));
        // console.log("formdata[instructions]: ",formData.get("instructions"))
        formData.append("status", COURSE_STATUS.DRAFT);
        // console.log("formdata[status]: ",formData.get("status"))
        setLoading(true);
        // console.log("BEFORE add course API call");
        // console.log("PRINTING FORMDATA", formData.data);
